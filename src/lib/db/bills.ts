 ...
 * The bill_number and due_date are automatically generated by database triggers
 *
 * @param payload - Bill data to insert
 * @returns Promise<Bill> - The created bill object with generated ID and bill_number
 ...
 *
 * @param billNumber - The bill number to search for (e.g., "BILL-25-001")
 * @returns Promise<Bill | null> - The bill object or null if not found
 * @throws Error if database operation fails
 */
